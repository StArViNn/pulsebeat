...
<head>
    ...
    <title>{{ config('app.name', 'Pulse Beat') }}</title>
...
<body style="background-color: #111727;">
    <div id="app">
        <nav class="navbar navbar-expand-md " style="background-color: #4c5262; ">
            <div class="container">
                <a class="navbar-brand" style="color : #fff;" href="{{ url('/') }}">
                    {{ config('app.name', 'Pulse Beat') }}
                </a>
